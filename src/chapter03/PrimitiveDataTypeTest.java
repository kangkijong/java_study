...
//		char str2 = "홍";	// '' 사용 가능
		...
		// 상수 정의 : 프로그램 시작부터 종류까지 같은 값을 가지며, 상수명은 전체 대문자로 선언
		// final 키워드를 앞에 정의해야 함
		// 프로그램 시작 : START(1), 종료 : END(0)
		final int START = 1;
//		START = 2;	// 상수로 선언했기 때문에 값을 바꾸려고 하면 오류 발생
		final int END = 0;
		...
		System.out.println("char ascii : " + c_asc);	// 97 -> 98
